...
const MILEFUON_VERSION = readMilefuonVersion();
...
<html>
<head><meta charset="utf-8"><title>Milefuon Companion</title>
<style>
...
<body><!-- BRANDING --><h1>Milefuon Companion</h1>
...
function bootstrapPage(key) {
  ...
  return `<!DOCTYPE html>
<html>
  <head><meta charset="utf-8"><title>Opening Milefuon Companion</title></head>
<body>
<script>
...
function brandMarkup() {
  const version = escapeHtmlText(MILEFUON_VERSION);
  const text = 'Milefuon v' + version;
